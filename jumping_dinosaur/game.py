    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mouse_pos[0] < restart_rect.right \
                    and mouse_pos[0] > restart_rect.left \
                    and mouse_pos[1] < restart_rect.bottom \
                    and mouse_pos[1] > restart_rect.top:
                    return True
